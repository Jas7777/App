...
def test_img():
   ...
   cv_img = []
   y = []
   for img in glob.glob(r'C:\Users\j-aro\OneDrive\Desktop\test9\non-autistic\*.jpg'):
      y.append(0)
      img1 = Image.open(img)
      # Added code
    ...
    #  if(counter==5000):
          #break
   #print(counter)
   for img in glob.glob(r'C:\Users\j-aro\OneDrive\Desktop\test9\autistic\*.jpg'):
      y.append(1)
      img1 = Image.open(img)
      img1 = img1.resize((100, 100))
      reshaped_image=np.transpose(img1)
   ...
   img2 = Image.open(r'C:\Users\j-aro\OneDrive\Desktop\test9\test\img10.jpg')
...
if img_file:
   ...
   cropped_img.save(r'C:\Users\j-aro\OneDrive\Desktop\test9\test\img10.jpg')
